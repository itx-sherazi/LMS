    ...
    if (response?.success) { // ✅ Fix the typo here
        ...
        function handleFilterOnChange(getSectionId, getCurrentOption) {
            ...
            if (!cpyFilters[getSectionId]) {
                cpyFilters[getSectionId] = [getCurrentOption.id]; // ✅ Only store the ID
            } else {
                const indexOfCurrentOption = cpyFilters[getSectionId].indexOf(getCurrentOption.id);
                
                if (indexOfCurrentOption === -1) {
                    cpyFilters[getSectionId].push(getCurrentOption.id); // ✅ Store only the ID
                } else {
            ...
            sessionStorage.setItem("filters", JSON.stringify(cpyFilters)); // ✅ Convert object to string properly
        }
